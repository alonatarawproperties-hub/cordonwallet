 ...
 *
 * Usage:
 *   node scripts/create-treasury-atas.js <PAYER_KEYPAIR_PATH>
 *
 * Example:
 *   node scripts/create-treasury-atas.js ~/.config/solana/id.json
 *
...
async function main() {
  ...
  if (!keypairPath) {
    console.error("Usage: node scripts/create-treasury-atas.js <PAYER_KEYPAIR_PATH>");
    console.error("Example: node scripts/create-treasury-atas.js ~/.config/solana/id.json");
    process.exit(1);
  }
