...
import { View, StyleSheet, Pressable, TextInput, Keyboard, Modal, Platform } from "react-native";
    ...
    >
      ...
      <WebView
        ...
        userAgent={Platform.select({
          ios: "Mozilla/5.0 (iPhone; CPU iPhone OS 17_0 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/17.0 Mobile/15E148 Safari/604.1 CordonWallet/1.0 (WebView)",
          default: "Mozilla/5.0 (Linux; Android 13) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Mobile Safari/537.36 CordonWallet/1.0 (WebView)",
        })}
      />
