import { Chain, mainnet, polygon, bsc, sepolia, polygonAmoy, bscTestnet } from "viem/chains";
...
const MAINNET_CHAINS: ChainConfig[] = [
  {
    ...
    nativeSymbol: "ETH",
    nativeDecimals: 18,
    rpcUrl: process.env.EXPO_PUBLIC_ETH_RPC_URL || "https://eth.llamarpc.com",
  ...
  },
  {
    ...
    nativeSymbol: "MATIC",
    nativeDecimals: 18,
    rpcUrl: process.env.EXPO_PUBLIC_POLYGON_RPC_URL || "https://polygon.llamarpc.com",
